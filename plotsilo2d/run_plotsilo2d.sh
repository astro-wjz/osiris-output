...
# INPUT INFORMATION
codepath="/Users/astrowjz/Desktop/read_h5/trans2silo"
workpath="/Users/astrowjz/Desktop/read_h5"  # PATH TO /FLD/
folders=("bf" "ef")
n_row=160   # cell number of r direction
n_col=320   # cell number of z direction
phi0=90.00   # slice to be drawn
zmin=0.00
zmax=200.00
rmax=100.00
coord="carte" # "carte" or "polar"   # output var bx by or br bphi
...
do
    ...
    for((i=1;i<=$n;i++))
    do
        ./test.e ${n_row} ${n_col} ${phi0} ${workpath} ${folders[$nfolder-1]} ${list1[$i-1]} ${list2[$i-1]} ${list3[$i-1]} ${rmax} ${zmin} ${zmax} ${coord}
